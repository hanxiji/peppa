          ...
          for(var k=0 ;k< childs ;k++){
            ...
            if(result_product==''&& n==0){
                if(result_class!=''){
                    ...
                    result_html+= '<li type="search" dd_name="搜索推荐"  id="li_'+b+'" value="' +b+ '" onclick=\'form_submit("","'+title_showtext+'",'+b+',"'+all_keys+'","searchinput")\' onmouseover="mo(this.value);overchangedata('+b+','+suggesttype+')" onmouseout="outchangedata('+b+','+suggesttype+')"><span class="d">约' +showvalue+'个结果</span><div id="key_'+b+'" '+class_name+'><div title="'+title_showtext+'">'+showtext+'</div></div>'+listhtml+'</li>';
                    i++;
                }
            }else{
                result_html+= '<li type="search" dd_name="搜索推荐"  id="li_'+b+'" value="' +b+ '" onclick=\'form_submit("","'+title_showtext+'",'+b+',"'+all_keys+'","searchinput")\' onmouseover="mo(this.value);overchangedata('+b+','+suggesttype+')" onmouseout="outchangedata('+b+','+suggesttype+')"><span class="d">约' +showvalue+'个结果</span><div id="key_'+b+'" '+class_name+'><div title="'+title_showtext+'">'+showtext+'</div></div>'+listhtml+'</li>';
