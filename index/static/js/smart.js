(function () {
    ...
    function ie6() {
        return window.navigator.userAgent.indexOf("MSIE 6.0") > 0
    }
    ...
    function productImg(pid, size, img_num) {
        ...
        if (img_num > 1000) {
            ...
            size = (typeof size == 'undefined' ? 'l' : size);
            return 'http://img3m' + pid % 10 + '.ddimg.cn/' + pid % 99 + '/' + pid % 37 + '/' + pid + '-' + img_num + '_' + size + '_' + img_version + '.jpg'
        } else {
            size = (typeof size == 'undefined' ? 'l' : size);
            return 'http://img3m' + pid % 10 + '.ddimg.cn/' + pid % 99 + '/' + pid % 37 + '/' + pid + '-' + img_num + '_' + size + '.jpg'
        }
    }
    ...
    var LAZY = {
        ...
        , scrollLeft: function () {
            return window['pageXOffset'] || LAZY.box && document.documentElement.scrollLeft || document.body.scrollLeft
        }
        , scrollTop: function () {
            return window['pageYOffset'] || LAZY.box && document.documentElement.scrollTop || document.body.scrollTop
        }
        , appear: function (elem) {
            var off = LAZY.offset(elem);
            return ((LAZY.width(window) + LAZY.scrollLeft()) > off.left) && (LAZY.height(window) + LAZY.scrollTop() > off.top)
        }
    ...
    window.DD_ADSMART = DD_ADSMART = {
        ...
        showCPCCat: function (id, page, guanid, display_style, pos, wide) {
            ...
            rdm = catDat[id].rdm;
            var bak = catDat[id].bak;
            while (tmp = c.firstChild) {
                c.removeChild(tmp);
            }
            var pagesize = (wide == 1) ? 4 : 3;
            if (ccc[id] && ccc[id].length == 3 && display_style == 0) {
                var cm = $C('DIV'), cl = $C('DIV'), cc = $C('DIV'), cr = $C('DIV');
                cm.className = 'slide_panel';
                cl.className = 'slide_panel_left';
                cc.className = 'slide_panel_content';
                cr.className = 'slide_panel_right';
                ...
                for (var i = 0; i < 3; i++) {
                    ...
                    var pUrl = (ccc[id][i].url.indexOf('http://') < 0) ? host + ccc[id][i].url + ccc[id][i].curl : ccc[id][i].url + ccc[id][i].curl;
                    ...
                    aPic.rel = 'nofollow';
                    //var spe = ccc[id][i].name.indexOf('<br><br>') == -1 ? '<br>' : '<br><br>', tmp_name = ccc[id][i].name;
                    //tmp_name = tmp_name.split(spe, 2);
                    //tmp_name[1] = tmp_name[1] ? tmp_name[1] : '';
                    //ccc[id][i].name = cutStr(tmp_name[0], 16) + "<br>" + cutStr(tmp_name[1], 16);
                    aProd.innerHTML = ccc[id][i].name;
                    aPic.title = aProd.title = ccc[id][i].name_h;
                ...
                ci.className = 'slide_icon';
                al.className = (page < 1) ? 'btn_left bof' : 'btn_left';
                al.title = '上一页';
                ar.className = bak ? 'btn_right eof' : 'btn_right';
                ar.title = '下一页';
                al.id = 'prev_page';
                ar.id = 'next_page';
                $A(cr, ar);
                ...
                for (var i = 0; i < pagesize; i++) {
                    ...
                    if (pos == 7) {
                        ...
                        cPrice.innerHTML = '<span class="price_m" style="text-decoration: none">定价：</span><span class="price_m">' + mPrice + '</span>';
                    }
                    $A(cPriceNew, sPriceD);
                    $A(cDetail, cTitle);
                    $A(cDetail, cPrice);
                    ...
                    $A(cItem, cDetail);
                    if (i == 0) {
                        cItem.className = 'slideitem clearfix first'
                    }
                    seqs += ccc[id][i].pos_num + ',';
                    ad_ids += ccc[id][i].ad_id + ',';
                    extra_orgs += (ccc[id][i].extra_org + ',');
            ...
            if (DD_ADSMART.cptSlide[pos].length > 0) {
                ...
                if (style == 'cat_slider') {
                    ...
                    for (var k = 0; k < DD_ADSMART.cptSlide[pos].length; k++) {
                        if (k == 0) {
                            $A(img_div, DD_ADSMART.createCPTSlideContent(pos, k, "inline", style, inner));
                        }
                        else {
                            $A(img_div, DD_ADSMART.createCPTSlideContent(pos, k, "", style, inner));
                        }
                    }
                    $A(c, img_div);
                    if (DD_ADSMART.cptSlide[pos].length > 1) {
        ...
        showCPTSlide: function (pos1, pos2, pos3, pos4, style, inner, wide) {
            ...
            if ((DD_ADSMART.cptSlide[pos].length > 0) && (DD_ADSMART.cptSlide[pos][0].ad_content.length > 0)) {
                ...
                DD_ADSMART.cptSlide[pos].sort(function (a, b) {
                ...
                if (style == 'home') {
                    ...
                    span1 = $C("span");
                    span1.className = "corner left_bottom imageElement";
                    span2 = $C("span");
                    span2.className = "corner right_bottom imageElement";
                    $A(div, span1);
                    $A(div, span2);
                    $A(c, div);
                    ...
                    for (var k = 0; k < DD_ADSMART.cptSlide[pos].length; k++) {
                        if (k == 0) {
                            $A(p, DD_ADSMART.createCPTSlideContent(pos, k, "", style, inner, wide));
                        } else {
                            $A(p, DD_ADSMART.createCPTSlideContent(pos, k, "none", style, inner, wide));
                        }
                    }
                    span1 = $C("span");
                    span1.className = "corner left_top imageElement";
                    span2 = $C("span");
                    span2.className = "corner right_top imageElement";
                    span3 = $C("span");
                    span3.className = "corner left_bottom imageElement";
                    span4 = $C("span");
                    span4.className = "corner right_bottom imageElement";
                    $A(div, p);
                    $A(div, span1);
                    $A(div, span2);
                    $A(div, span3);
                    ...
                    for (var k = 0; k < DD_ADSMART.cptSlide[pos].length; k++) {
                        if (k == 0) {
                            $A(span, DD_ADSMART.createCPTSlideContent(pos, k, "", style, inner, wide));
                        } else {
                            $A(span, DD_ADSMART.createCPTSlideContent(pos, k, "none", style, inner, wide));
                        }
                    }
                    $A(div, span);
                    $A(c, div_top);
        ...
        cptSlideClearInterval: function (pos, style) {
            return function () {
                if (DD_ADSMART.cptSlideTimer[pos] != null) {
                    clearInterval(DD_ADSMART.cptSlideTimer[pos])
                }
            }
        }
        ,
        cptSlideSetInterval: function (pos, style) {
            ...
            if (style == "group_buying") {
                intervalTime = 4000;
            }
            return function () {
                DD_ADSMART.cptSlideTimer[pos] = setInterval(DD_ADSMART.timeoutGo(pos, style), intervalTime);
            }
        }
        ,
            ...
            return function () {
                if (style == "home") {
                    ...
                    for (; k < DD_ADSMART.cptSlide[pos].length; k++) {
                        ...
                        if ((typeof item.className != 'undefined') && (item.className == 'now' || item.className == 'other now')) {
                            break;
                        }
                    }
                    ...
                    for (; k < DD_ADSMART.cptSlide[pos].length; k++) {
                        var item = $("ad_title_" + pos + '_' + k);
                        if ((typeof item.className != 'undefined') && (item.className == 'active')) {
                            break;
                        }
                    }
                    if (k == DD_ADSMART.cptSlide[pos].length - 1) {
                    ...
                    for (; k < DD_ADSMART.cptSlide[pos].length; k++) {
                        var item = $("ad_title_" + pos + '_' + k);
                        if ((typeof item.className != 'undefined') && (item.className == 'on')) {
                            break;
                        }
                    }
                    if (k == DD_ADSMART.cptSlide[pos].length - 1) {
                    ...
                    if (k == DD_ADSMART.cptSlide[pos].length - 1) {
                        ...
                        DD_ADSMART.cptSlideGo(pos, $("ad_pic_" + pos + '_' + (k + 1)), style);
                    }
                }
            }
        }
        ...
        cptSlideGo: function (pos, e, style) {
            if (style == "search" && DD_ADSMART.cptSlide[pos].length > 1) {
                ...
                if (typeof e.className == 'undefined' || e.className == '') {
                    e.className = 'now'
                } else if (e.className == 'other') {
                    e.className = 'other now';
                }
        ...
        cptSlideGoTo: function (pos, e, style) {
            return function () {
                return DD_ADSMART.cptSlideGo(pos, e, style);
            }
        }
        ,
                ...
                if (style == 'home_alter') {
                    if (DD_ADSMART.cptSlide[pos].length == 1) {
                        ...
                        switch (DD_ADSMART.cptSlide[pos].length) {
                            case 2:
                                ul.className = "leveltab_title";
                                break;
                            case 3:
                                ul.className = "leveltab_title leveltab_title_three";
                                break;
                            case 4:
                            default:
                                break;
                    ...
                    for (var i = 0; i < DD_ADSMART.cptSlide[pos].length; i++) {
                        ...
                        if (DD_ADSMART.cptSlide[pos][i].ad_content[0].tag_info != undefined) {
                            ...
                            if (DD_ADSMART.cptSlide[pos].length > 1) {
                                bind(titleA, 'mouseover', DD_ADSMART.cptSlideGoTo(pos, titleA, 'home_alter'))
                            }
                            $A(titlewrap, titleA);
                        }
                        $A(ul, titlewrap);
                    ...
                    for (var i = 0; i < DD_ADSMART.cptSlide[pos].length; i++) {
                        ...
                        if (DD_ADSMART.cptSlide[pos][i].ad_content[0].tag_info != undefined) {
                            ...
                            if (i == 0) {
                                title_a.className = "active";
                            } else {
                                title_a.className = ""
                            }
                            if (DD_ADSMART.cptSlide[pos].length > 1) {
                                bind(title_a, 'mouseover', DD_ADSMART.cptSlideGoTo(pos, title_a, 'group_buying'))
                            }
                            $A(div, title_a);
                        }
                    }
                    ...
                    for (var i = 0; i < DD_ADSMART.cptSlide[pos].length; i++) {
                        ...
                        if (DD_ADSMART.cptSlide[pos].length > 1) {
                            bind(li, 'mouseover', DD_ADSMART.cptSlideGoTo(pos, li, 's_slide'))
                        }
                        $A(ul, li);
                    }
                    return ul;
                    ...
                    for (var i = 0; i < DD_ADSMART.cptSlide[pos].length; i++) {
                        ...
                        if (DD_ADSMART.cptSlide[pos][i].ad_content[0].tag_info != undefined) {
                            ...
                            if (i == 0) {
                                title_li.className = "on";
                            } else {
                                title_li.className = ""
                            }
                            if (DD_ADSMART.cptSlide[pos].length > 1) {
                                bind(title_li, 'mouseover', DD_ADSMART.cptSlideGoTo(pos, title_li, 'slide_banner'))
                            }
                            $A(ul, title_li);
                        }
                    }
                    ...
                    switch (DD_ADSMART.cptSlide[pos].length) {
                        case 1:
                            ...
                            break;
                        case 2:
                            h2.className = "column2";
                            break;
                        case 3:
                            h2.className = "column3";
                            break;
                        case 4:
                        default:
                            break;
                    ...
                    for (var i = 0; i < DD_ADSMART.cptSlide[pos].length; i++) {
                        ...
                        titleA.id = "ad_title_" + pos + '_' + i;
                        if (DD_ADSMART.cptSlide[pos].length == 1) {
                            titleA.className = "other now";
                        } else {
                            if (i == 0) {
                                titleA.className = "now";
                            } else if (i == DD_ADSMART.cptSlide[pos].length - 1) {
                                titleA.className = "other";
                            }
                        }
                        if (DD_ADSMART.cptSlide[pos].length > 1) {
                            bind(titleA, 'mouseover', DD_ADSMART.cptSlideGoTo(pos, titleA, 'home'))
                        }
                        $A(h2, titleA);
                    }
                    return h2;
                    ...
                    if (DD_ADSMART.cptSlide[pos].length == 1)
                        ...
                        switch (DD_ADSMART.cptSlide[pos].length) {
                            case 2:
                                div.className = "homepage_outbanner_tab homepage_outbanner_tab2";
                                break;
                            case 3:
                                div.className = "homepage_outbanner_tab homepage_outbanner_tab3";
                                break;
                            case 4:
                            default:
                                break;
                    ...
                    for (var i = 0; i < DD_ADSMART.cptSlide[pos].length; i++) {
                        ...
                        if (DD_ADSMART.cptSlide[pos].length > 1) {
                            bind(titleA, 'mouseover', DD_ADSMART.cptSlideGoTo(pos, titleA, style))
                        }
                        $A(div, titleA);
                    }
                    return div;
        ...
        createCPTSearchSlideTitle: function (pos, style) {
            if (DD_ADSMART.cptSlide[pos].length > 0) {
                if (style == "search") {
                    ...
                    switch (DD_ADSMART.cptSlide[pos].length) {
                        case 1:
                            div.className = "tab_panel clearfix panel1";
                            break;
                        case 2:
                            div.className = "tab_panel clearfix panel2";
                            break;
                        case 3:
                            div.className = "tab_panel clearfix panel3";
                            break;
                        case 4:
                        default:
                            div.className = "tab_panel clearfix panel4";
                            break;
                    }
                    for (var i = 0; i < DD_ADSMART.cptSlide[pos].length; i++) {
                        var titleA = $C("a");
                        ...
                        if (DD_ADSMART.cptSlide[pos].length > 1) {
                            bind(titleH2, 'mouseover', DD_ADSMART.cptSlideGoTo(pos, titleA, 'search'))
                        }
                        $A(titleH2, titleA);
                        $A(div, titleH2);
                    }
                    ...
                    switch (DD_ADSMART.cptSlide[pos].length) {
                        case 1:
                            ul.className = "schleft_tabad_title clearfix";
                            break;
                        case 2:
                            ul.className = "schleft_tabad_title schleft_tabad2 clearfix";
                            break;
                        case 3:
                            ul.className = "schleft_tabad_title schleft_tabad3 clearfix";
                            break;
                        case 4:
                        default:
                            ul.className = "schleft_tabad_title schleft_tabad4 clearfix";
                            break;
                    }
                    for (var i = 0; i < DD_ADSMART.cptSlide[pos].length; i++) {
                        var titleA = $C("a");
                    ...
                    for (var i = 0; i < DD_ADSMART.cptSlide[pos].length; i++) {
                        ...
                        if (DD_ADSMART.cptSlide[pos].length > 1) {
                            bind(titleA, 'mouseover', DD_ADSMART.cptSlideGoTo(pos, titleA, 'multysearch'))
                        }
                        $A(span, titleA);
                        $A(p, span);
                    }
        ...
        createCPT: function (pos, type, style, inner, name, wide) {
            ...
            if (DD_ADSMART.cpt_ad[pos].cpt_type == 0 || DD_ADSMART.cpt_ad[pos].cpt_type == 2) {
                if (style == 1) {
                    ...
                    var monitor = DD_ADSMART.cpt_ad[pos].monitor||0;
                    img.src = (/^\d_/.test(src)) ? host + 'static/images/' + src : this.getFullImageURL(src);
                    ...
                    var div = $C('DIV');
                    div.setAttribute('ddt-pit','seq0');
                    if (monitor==1) {
                        var mz_caid = DD_ADSMART.cpt_ad[pos].mz_active||'';
                        var mz_spid = DD_ADSMART.cpt_ad[pos].mz_position||'';
                        div.setAttribute('ddt-expose',"on");
                        div.setAttribute('miaozhen-caid',mz_caid);
                        div.setAttribute('miaozhen-spid',mz_spid);
                        a.setAttribute('miaozhen-caid', mz_caid);
                        a.setAttribute('miaozhen-spid', mz_spid);
                    }
                    $A(p, a);
                    div.className = name;
                    $A(div, p);
                    ...
                    var src = (wide == 1) ? DD_ADSMART.cpt_ad[pos].ad_content[0].ad_img_big : DD_ADSMART.cpt_ad[pos].ad_content[0].ad_img;
                    var monitor = DD_ADSMART.cpt_ad[pos].monitor||0;
                    outer.setAttribute('ddt-pit','seq0');
                    img.src = (/^\d_/.test(src)) ? host + 'static/images/' + src : this.getFullImageURL(src);
                    a.href = (/^\d_/.test(src)) ? DD_ADSMART.cpt_ad[pos].ad_content[0].ad_url : host + DD_ADSMART.cpt_ad[pos].ad_content[0].ad_url;
                    a.target = '_blank';
                    a.rel = 'nofollow';
                    if (monitor==1) {
                        var mz_caid = DD_ADSMART.cpt_ad[pos].mz_active||'';
                        var mz_spid = DD_ADSMART.cpt_ad[pos].mz_position||'';
                        outer.setAttribute('ddt-expose',"on");
                        outer.setAttribute('miaozhen-caid',mz_caid);
                        outer.setAttribute('miaozhen-spid',mz_spid);
                        a.setAttribute('miaozhen-caid', mz_caid);
                        a.setAttribute('miaozhen-spid', mz_spid);
                    }
                    if (DD_ADSMART.cpt_ad[pos].ad_content[0].ad_des.length > 0) {
                    ...
                    var outer = $C('DIV');
                    div = $C('DIV'), a = $C('A'), close = $C('A'), img = $C('IMG');
                    div.setAttribute('ddt-pit','seq0');
                    var src = (wide == 1) ? DD_ADSMART.cpt_ad[pos].ad_content[0].ad_img_big : DD_ADSMART.cpt_ad[pos].ad_content[0].ad_img;
                    var monitor = DD_ADSMART.cpt_ad[pos].monitor||'';
                    img.src = (/^\d_/.test(src)) ? host + 'static/images/' + src : this.getFullImageURL(src);
                    a.href = (/^\d_/.test(src)) ? DD_ADSMART.cpt_ad[pos].ad_content[0].ad_url : host + DD_ADSMART.cpt_ad[pos].ad_content[0].ad_url;
                    a.target = '_blank';
                    a.rel = 'nofollow';
                ...
                if (DD_ADSMART.cpt_ad[pos].type = 'mobile_ad_tag') {
                    ...
                    for (var i = 0; i < DD_ADSMART.cpt_ad[pos].ad_content.length; i++) {
                        ...
                        if (monitor==1) {
                            var mz_caid = DD_ADSMART.cpt_ad[pos].mz_active||'';
                            var mz_spid = DD_ADSMART.cpt_ad[pos].mz_position||'';
                            li.setAttribute('ddt-expose',"on");
                            li.setAttribute('miaozhen-caid',mz_caid);
                            li.setAttribute('miaozhen-spid',mz_spid);
                            a.setAttribute('miaozhen-caid', mz_caid);
                            a.setAttribute('miaozhen-spid', mz_spid);
                        }
                        $A(li, a);
                    ...
                    $A(div, ul);
                    var divmain = $C('DIV');
                    $A(divmain, DD_ADSMART.createCPTpromt());
                    $A(divmain, div);
                    return divmain
                }
                ...
                for (var i = 0; i < DD_ADSMART.cpt_ad[pos].ad_content.length; i++) {
                    ...
                    if (monitor==1) {
                        ...
                        li.setAttribute('miaozhen-caid',mz_caid);
                        li.setAttribute('miaozhen-spid',mz_spid);
                        a_pic.setAttribute('miaozhen-caid', mz_caid);
                        a_pic.setAttribute('miaozhen-spid', mz_spid);
                    }
                    var img = $C('IMG');
                ...
                if (style == "popup") {
                    ...
                    if (monitor==1) {
                        ...
                        div.setAttribute('miaozhen-caid', mz_caid);
                        div.setAttribute('miaozhen-spid', mz_spid);
                        closed_w.setAttribute('miaozhen-caid', mz_caid);
                        closed_w.setAttribute('miaozhen-spid', mz_spid);
                    }
                    ...
                    if (monitor==1) {
                        ...
                        div.setAttribute('miaozhen-caid', mz_caid);
                        div.setAttribute('miaozhen-spid', mz_spid);
                        w_a.setAttribute('miaozhen-caid', mz_caid);
                        w_a.setAttribute('miaozhen-spid', mz_spid);
                    }
                    w_a.target = "_blank";
